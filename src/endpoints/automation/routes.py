...
async def parse_swagger_to_spec(
    request: SwaggerSpecRequest = Body(...)
) -> APISpecResponse:
    """
...
async def parse_curl_to_spec(
    request: CurlSpecRequest = Body(...)
) -> APISpecResponse:
    """
...
async def parse_to_spec(
    request: APISpecRequest = Body(...)
) -> APISpecResponse:
    """
...
async def generate_test_scripts(
    request: GenerateScriptRequest = Body(...)
) -> GenerateScriptResponse:
    """
...
async def generate_tests_gpt5mini(
    request: TestCaseRequest = Body(...)
) -> TestCaseResponse:
    """
...
async def generate_tests_gpt4o(
    request: TestCaseRequest = Body(...)
) -> TestCaseResponse:
    """
...
async def generate_tests_runner_o4_mini(
    request: TestCaseRequest = Body(...)
) -> TestCaseResponse:
    """
...
async def generate_tests_runner_claude_sonnet_4(
    request: TestCaseRequest = Body(...)
) -> TestCaseResponse:
    """
