...
import logging
import json
from endpoints.prompts.claude4.prompts import get_judge_system_message, get_judge_prompt

logger = logging.getLogger(__name__)


class TestCaseJudgeAgentClaude4:
    """
    LLM-based judge agent that reviews and evaluates test cases using Claude Sonnet.
    Evaluates test cases based on accuracy, consistency, factualness, completeness, and other quality metrics.
    """

    def __init__(self, api_key: str = None):
        """
        Initialize the TestCaseJudgeAgent.
    ...
    def review_test_cases(
        ...
        try:
            ...
            prompt = get_judge_prompt(test_cases_json, api_spec)
            ...
            completion = self.llm_client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": get_judge_system_message()
                    },
