"""kanban-poc/backend/task_validator.py
...
def validate_task_metadata(
    *,
    ...
    # Optional cross-field rule (POC): if email exists, name may be omitted; if name exists, email may be omitted.
    # If you want to enforce both-or-none, implement it here.
